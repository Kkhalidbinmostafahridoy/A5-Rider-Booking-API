...
const requestRide = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        const riderId = (_a = req.user) === null || _a === void 0 ? void 0 : _a.userId; //user error line vercel thats why user req as any
        if (!riderId) {
        ...
        const activeRide = yield rider_model_1.Ride.findOne({
            ...
            status: {
                $in: [
                    rider_interface_1.RideStatus.Requested,
                    rider_interface_1.RideStatus.Accepted,
...
const cancelRide = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const userId = (_a = req.user) === null || _a === void 0 ? void 0 : _a.userId; //user error line vercel thats why user req as any
        ...
        const now = new Date();
        const createdAt = ride.createdAt || now; //rider error line vercel thats why use rider as any
        const diffMinutes = (now.getTime() - createdAt.getTime()) / (1000 * 60);
        if (diffMinutes > 10) {
            throw new AppError_1.default(400, "Cancel window expired (10 mins)");
        }
        ride.status = "cancelled"; //rider error line vercel thats why use rider as any
...
exports.getRideHistory = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const totalRequested = rides.filter((ride) => ride.status === "requested").length;
